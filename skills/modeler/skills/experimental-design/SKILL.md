...
description: "Design experiments before data collection. Use for randomization, blocking, controls, factorial or fractional-factorial DOE, response surfaces, crossover, split-plot, cluster, Latin-square, plate-layout, sequential designs, or pseudoreplication checks."
---
