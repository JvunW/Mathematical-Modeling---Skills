...
Requests should include `$mathmodel-figure-templates` and the human-readable figure title when explicit invocation is desired. Convert that title to one of the ids above and call `scripts/render_template.py` relative to the skill directory.
