...
def generate_pdf(
    ...
    try:
        ...
        print("Install Pandoc from https://pandoc.org/installing.html or your system package manager.")
        return False
...
def check_dependencies():
    ...
    if missing:
        ...
        for dep in missing:
            if dep == 'pandoc':
                print("  - pandoc: https://pandoc.org/installing.html (or your system package manager)")
            elif dep == 'xelatex':
                print("  - xelatex: install TeX Live, MacTeX, or MiKTeX for your operating system")
        return False
